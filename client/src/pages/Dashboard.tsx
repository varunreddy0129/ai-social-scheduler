    ...
    return (
        <div className="space-y-8">
            ...
            <div>
                ...
                <p className="text-slate-500 text-sm mt-0.5">Here's what happening with your social accounts today.</p>
            </div>
                    ...
                    <div className="divide-y divide-slate-50">
                        {activities.map((activity)=>(
                            <div key={activity._id} className="flex items-start gap-4 px-6 py-4 hover:bg-slate-50/50 transition-colors">
                                <div className="h-9 w-9 rounded-xl flex items-center justify-center shrink-0 mt-0.5 bg-zinc-100 text-zinc-600">
